...
# from ..app import Amazonhqlocator
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.amazonhqlocator"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.amazonhqlocator.tests.tests"

        To run tests in the AmazonhqlocatorTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.amazonhqlocator.tests.tests.AmazonhqlocatorTestCase"

        To run only the test_if_tethys_platform_is_great function in the AmazonhqlocatorTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.amazonhqlocator.tests.tests.AmazonhqlocatorTestCase.test_if_tethys_platform_is_great"
...
class AmazonhqlocatorTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(Amazonhqlocator)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(Amazonhqlocator)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/amazonhqlocator/')  # The final '/' is essential for all pages/controllers
